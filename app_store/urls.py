...
from .views import cart_view_json, cart_add_view_json, cart_del_view_json,\
    cart_view, coupon_check_view, delivery_estimate_view, cart_buy_now_view, cart_remove_view
...
urlpatterns = [
    ...
    path('cart/add/<id_product>', cart_add_view_json, name="add_to_cart"),
    path('cart/del/<id_product>', cart_del_view_json, name="remove_from_cart"),
